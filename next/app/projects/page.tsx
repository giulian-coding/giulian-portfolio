        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {otherProjects.map((project, index) => (
              <div
                key={index}
                className="group p-5 rounded-xl bg-background border border-border hover:border-primary/50 transition-all duration-300 flex flex-col"
              >
